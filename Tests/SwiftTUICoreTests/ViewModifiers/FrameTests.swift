...
struct FrameTests {
    ...
    func heightOnlyTop() async throws {
        expectView(in: Size(width: 6, height: 5)) {
            Text("Hi")
    ...
    func expandingViewWithFrame() async throws {
        expectView(in: Size(width: 10, height: 10)) {
    ...
    func expandingViewTopLeading() async throws {
        expectView(in: Size(width: 8, height: 6)) {
            ExpandingView(char: "X")
    ...
    func multiLineTextCentered() async throws {
        expectView(in: Size(width: 10, height: 6)) {
            Text("Hi There")
    ...
    func vstackWithFrame() async throws {
        expectView(in: Size(width: 10, height: 8)) {
            ...
            .frame(width: 6, height: 4, alignment: .topLeading)
        } toRender: {
            """
            ..........
            ..........
